...
$adtSession = @{
    ...
    AppScriptAuthor = 'XOAP.io'
    
    # XOAP additions to variables.
    AppTags = ''
    PackageName = ''
    PackageType = ''
...
function Install-ADTDeployment
{
    ...
    Register-ADTInstallation

    ## Display a message at the end of the install.
    if (!$adtSession.UseDefaultMsi)
    {
        Show-ADTInstallationPrompt -Message 'Installation completed successfully' -ButtonRightText 'OK' -Icon Information -NoWait
    }
}
